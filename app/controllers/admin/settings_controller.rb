class Admin::SettingsController < Admin::ApplicationController
  ...
  def update
  	...
  	if @setting.update(settings_params)
  		...
  		flash[:alert] = 'There was a problem update setting'
  		render :edit
  	end
  end
  ...
  private
  def settings_params
  	params.require(:setting).permit(:id, :site_name, :post_per_page, :under_maintaenance, :prevent_commenting, :tag_visibility)
  end
end
